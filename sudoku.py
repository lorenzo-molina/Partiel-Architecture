#  1 : Création de la grille de jeu avec des chiffres placés aléatoirement.
#  2 : Input pour le joueur afin qu'il puisse placer son chiffre
...
#  5 : Afficher un message de victoire quand la grille est pleine et demander au joueur s'il veut rejouer
